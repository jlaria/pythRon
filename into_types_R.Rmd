...
<!-- <!-- Hyper-parameter optimization has attracted the attention of many researchers in these last years. Most of advanced model training algorithms nowadays require different hyper-parameters. --> 

<!-- <!-- The sparse-group lasso is a regularization method for regression and variable selection.  --> 

<!-- ## The foreach loop -->

<!-- We are going to work with the `Auto` data frame from the `ISLR` package. -->
