...
There are many different ways to install `R` and `python` in our personal computer, depending on the situation we would use one over the overs. In this course, we are going to rely on the `conda` environment to get everything ready. 
